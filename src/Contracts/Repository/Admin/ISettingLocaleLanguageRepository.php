...
namespace Menvel\SettingLocale\Contracts\Repository\Admin;
...
interface ISettingLocaleLanguageRepository extends Allable, Getable, Modifyable, Addable, Removeable
{
    //
}